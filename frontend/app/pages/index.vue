...
<template>
  <div class="flex flex-col gap-6 md:pt-8 pb-24 lg:pb-16">
    <div
    ...
    <div class="home__promotions">
      ...
      <PromotionalSlider class="home__promotions-slider" filter-name="is_promotion"/>
    </div>
    ...
    <div class="home__monthly">
      <h1 class="home__monthly-title capitalize text-3xl font-bold text-txt-sec mb-6">
        {{ $t('home.sushiTitle') }}
        <span> {{ $t('home.sushiTitleAccent') }} </span>
      </h1>
      <PromotionalSlider class="home__promotions-slider" filter-name="is_monthly"/>
    </div>
  </div>
</template>